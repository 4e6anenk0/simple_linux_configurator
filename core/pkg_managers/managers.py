...
class UniversalManager:
    ...
    @classmethod
    def install(cls, argument: str, options: list[Option] = None) -> str:
        '''Install the app'''
        pass

    @classmethod
    def remove(cls, argument: str, options: list[Option] = None) -> str:
        '''Remove the app'''
        pass
    ...
    @classmethod
    def add_repo(cls, argument: str, options: list[Option] = None) -> str:
        '''Add a repository or remote source'''
        pass

    @classmethod
    def remove_repo(cls, argument: str, options: list[Option] = None) -> str:
        '''Remove a repository or remote source'''
        pass

    @classmethod
    def purge(cls, argument: str, options: list[Option] = None) -> str:
